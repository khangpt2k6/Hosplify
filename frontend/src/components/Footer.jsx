...
const Footer = () => {
  return (
    <div className="bg-white pt-16 pb-6 md:mx-10 rounded-t-lg">
  ...
  Hospify
        ...
        <div>
          <p className="text-lg font-semibold mb-5 flex items-center">
            <svg
      ...
      <div>
        <div className="py-5 px-6 sm:px-10 flex justify-between items-center">
          <p className="text-sm text-gray-500">
            Copyright 2024 @ Hospify.com - All Right Reserved.
          </p>
          <div className="flex gap-4">
            <a
              href="#"
              className="w-8 h-8 flex items-center justify-center rounded-full bg-blue-100 text-blue-600 hover:bg-blue-600 hover:text-white transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
